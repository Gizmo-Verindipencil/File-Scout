...
{
    /// <summary>
    /// VB6のPRIVATE/FUNCTIONプロシージャー数の調査手段のテストを提供します。
    /// </summary>
    [TestClass]
    public class NumberOfVB6PrivateFunctionProceduresScoutingMethodUnitTest
    {
        /// <summary>
        /// テスト用ディレクトリのパスを取得します。
        /// </summary>
        private string DirectoryPath
        {
            get
            {
                ...
                var dir = Path.Combine(root, nameof(NumberOfVB6PrivateFunctionProceduresScoutingMethodUnitTest));
        ...
        public void Test_Do_ReturnsZero_WhenFileIsBinary()
        {
            ...
            // テスト対象の処理を実行
            var method = new NumberOfVB6PrivateFunctionProceduresScoutingMethod();
        ...
        /// <summary>
        /// VB6のPRIVATE/FUNCTIONプロシージャー数の調査結果を検証します。
        /// </summary>
        [TestMethod]

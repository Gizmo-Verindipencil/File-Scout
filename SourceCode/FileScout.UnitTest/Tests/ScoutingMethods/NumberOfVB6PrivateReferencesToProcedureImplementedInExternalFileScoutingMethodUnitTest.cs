...
{
    /// <summary>
    /// VB6の外部dll参照のPRIVATEプロシージャ数の調査手段のテストを提供します。
    /// </summary>
    [TestClass]
    public class NumberOfVB6PrivateReferencesToProcedureImplementedInExternalFileScoutingMethodUnitTest
    {
        /// <summary>
        /// テスト用ディレクトリのパスを取得します。
        /// </summary>
        private string DirectoryPath
        {
            get
            {
                ...
                var dir = Path.Combine(root, nameof(NumberOfVB6PrivateReferencesToProcedureImplementedInExternalFileScoutingMethodUnitTest));
        ...
        /// <summary>
        /// VB6の外部dll参照のPRIVATEプロシージャ数の調査結果を検証します。
        /// </summary>
        [TestMethod]

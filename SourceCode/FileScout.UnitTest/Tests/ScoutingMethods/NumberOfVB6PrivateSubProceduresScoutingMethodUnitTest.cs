...
{
    /// <summary>
    /// VB6のPRIVATE/SUBプロシージャー数の調査手段のテストを提供します。
    /// </summary>
    [TestClass]
    public class NumberOfVB6PrivateSubProceduresScoutingMethodUnitTest
    {
        /// <summary>
        /// テスト用ディレクトリのパスを取得します。
        /// </summary>
        private string DirectoryPath
        {
            get
            {
                ...
                var dir = Path.Combine(root, nameof(NumberOfVB6PrivateSubProceduresScoutingMethodUnitTest));
